...
export default function Home() {
  ...
  return <main>
    ...
    {step !== "home" && step !== "history" && data && <section className="workspace">
      ...
      {step === "water" && <>
        <div className="sectionIntro"><div><span className="sectionNo">01</span><h2>수도계량 입력</h2></div></div>
